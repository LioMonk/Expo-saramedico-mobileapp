...
/**
 * HospitalScheduleScreen
 * Unified Organizational Schedule View
 */
export default function HospitalScheduleScreen({ navigation }) {
    ...
    const loadData = async (isRefreshing = false) => {
        ...
        try {
            ...
            } catch (e) { console.warn('Could not fetch patient list'); }
    ...
    const renderItem = (item) => {
        ...
        return (
            <View key={item.id} style={styles.sexyCard}>
    ...
    allEvents.forEach(item => {
        ...
        markedDates[dateStr] = { marked: true, dotColor: item.itemType === 'appointment' ? COLORS.primary : '#9C27B0' };
    });
    if (selectedDate) {
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Organization Schedule</Text>
...
const styles = StyleSheet.create({
    ...
    calendarContainer: { backgroundColor: 'white', margin: 16, borderRadius: 20, overflow: 'hidden', elevation: 3 },
    tabsContainer: { flexDirection: 'row', paddingHorizontal: 16, marginTop: 16, gap: 10 },
    tab: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: 'white', borderWidth: 1, borderColor: '#E0E0E0' },
    activeTab: { backgroundColor: COLORS.primary, borderColor: COLORS.primary },
    tabText: { fontSize: 13, fontWeight: '600', color: '#666' },
    activeTabText: { color: 'white' },
    scrollContainer: { flex: 1, padding: 16 },
    sexyCard: { backgroundColor: 'white', borderRadius: 20, marginBottom: 16, flexDirection: 'row', overflow: 'hidden', elevation: 3 },
    sexySide: { width: 6 },
    ...
    pickerToggle: { flex: 1, backgroundColor: '#F5F7FA', padding: 12, borderRadius: 12, alignItems: 'center' },
